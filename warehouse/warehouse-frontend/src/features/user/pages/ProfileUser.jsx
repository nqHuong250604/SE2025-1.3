...
import {
  ...
  FiShield, FiPackage, FiEdit3, FiCheck, FiX, FiCamera
} from "react-icons/fi";
    ...
    <div className="flex items-start gap-4 p-4 border border-gray-100 rounded-xl bg-gray-50/50 hover:bg-white hover:shadow-sm transition-all duration-200">
      ...
      <div className="flex-1">
        ...
        {isEditable ? (
          ...
          <p className="text-gray-800 font-medium text-base truncate">{value}</p>
        )}
      </div>
    </div>
  );
...
const ProfileUser = () => {
  ...
  const [user, setUser] = useState({
    name: "Nguyễn Quang Hướng",
    role: "Nhân viên kho",
    email: "huong@example.com",
    phone: "0912345678",
    address: "123 Phạm Văn Đồng, TP.HCM",
  ...
  // -----------------------------
  // Config các field info (Tối ưu)
  // -----------------------------
  const infoFields = [
    { label: "Họ và tên", name: "name", icon: <FiUser size={18} /> },
    { label: "Chức vụ", value: user.role, readOnly: true, icon: <FiShield size={18} /> },
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 flex flex-col items-center text-center relative overflow-hidden">
              ...
              <p className="text-gray-500 font-medium mt-1">{user.role}</p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center pb-1">
                  ...
                  <span className="font-semibold text-blue-600">{user.warehouse}</span>
                </div>
              </div>
            </div>
          </div>
